...
module.exports = {
	...
	async execute(req, res) {
		...
		return res.render("EndPoints.ejs", { homeURL: `<a href="${domain}${port}">Home!</a>`, endpoints: listOfEndpoints, codeRequestSample: `${codeRequestSampleOne}<br>   requestedTemperature: 15<br>${codeRequestSampleTwo}` })
	}
}
